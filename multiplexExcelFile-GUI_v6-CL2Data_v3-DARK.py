...
# Need to update this to put data in a table format the way katherin has it in the ppt she updated, "MultiplexExpKatherine"
# Essentially I just need to move all the raw data to look like the new format...
...
def RunProgram():
    ...
    # spotlistdf3 = pd.DataFrame(spotlist3)
    # spotlistdf4 = pd.DataFrame(spotlist4)
...
save_text = tk.Label(root, text = "What do you want to call your save file?",bg = Red ,fg = "white", font=('calibre',10,'normal'))
Save_entry = tk.Entry(root, textvariable = savedir, font = ('calibre',10,'normal'), bg="white", fg = 'black')
save_note = tk.Label(root, text = "The save directory is automatically set to your home directory \n If you want it to go to a different directory you must specify that path from the home dir.",bg = Red ,fg = "white", font=('calibre',10,'normal'))
